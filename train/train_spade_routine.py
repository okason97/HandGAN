...
from datasets.coco import load_images_and_poses
...
if __name__ == "__main__":
    ...
    fixed_image, fixed_pose = next(iter(loader))
    fixed_y = fixed_pose
    ...
    for epoch in range(n_epochs):
        ...
        for batch_ndx, sample in enumerate(loader):
            ...
            if cur_step % len(ImageDatasetWrapper(image_datasets['val'])) == 0:
                fid_step += 1
                print('===========================================================================')
